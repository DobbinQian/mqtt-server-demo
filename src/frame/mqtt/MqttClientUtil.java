...
public class MqttClientUtil {
	 ...
	 */
	private static String broker = "tcp://xxxxxx:1883";
	...
	public static void createClient() {
		...
		String clientId = "mqtt" + String.valueOf(System.currentTimeMillis());
                ...
                mqttClient.connect(connOpts, null, new IMqttActionListener() {
					...
					public void onSuccess(IMqttToken asyncActionToken) {
                        try {
                            ...
                            MqttClientUtil.mqttClient.subscribe("xxxxxxxx", 0);

                            System.out.println("订阅主题:"+"xxxxxxxx");
                        } catch (MqttException me) {
							System.out.println("reason " + me.getReasonCode());
							System.out.println("msg " + me.getMessage());
							System.out.println("loc " + me.getLocalizedMessage());
